...
def admin_settings(request):
    ...
    return render(request, 'accounts/settings.html', {'settings': settings, 'groups': groups})
...
def admin_user_update(request, pk):
    ...
    return render(request, 'accounts/user_edit.html', {'user_obj': user_obj, 'groups': groups})
...
def admin_group_delete(request, pk):
    ...
    if request.method == 'POST':
        ...
        return redirect('admin_group_list')
    return render(request, 'accounts/group_delete_confirm.html', {'group': group, 'user_count': user_count})
